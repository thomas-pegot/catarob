...
class MainWindow(QMainWindow, Ui_MainWindow, Preprocessing):
	...
	def __init__(self, parent = None):
		...
		TermStream.stdout().messageWritten.connect(self.textBrowser.insertPlainText)
		TermStream.stderr().messageWritten.connect(self.textBrowser.insertPlainText)
		self.alloc_attr()
	...
	def update(self, context):
		"""Call class and update image, and window """
